...
public class main extends Thread {
    ...
    public void run() {
        ...
        try {
            ...
            System.out.println("SERVIDOR POTENCIA: Esperando Conexion...");
            sCliente = sServer.accept();
            System.out.println("SERVIDOR POTENCIA: conexion  Aceptada");
