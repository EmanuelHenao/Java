...
public class main extends Thread {
    ...
    public void run() {
        ...
        try {
            ...
            System.out.println("SERVIDOR DIVISION: Esperando Conexion...");
            sCliente = sServer.accept();
            System.out.println("SERVIDOR DIVISION: conexion  Aceptada");
