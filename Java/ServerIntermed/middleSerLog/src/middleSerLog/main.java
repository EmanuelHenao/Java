...
public class main extends Thread {
    ...
    public void run() {
        ...
        try {
            ...
            System.out.println("SERVIDOR LOG: Esperando Conexion...");
            sCliente = sServer.accept();
            System.out.println("SERVIDOR LOG: conexion  Aceptada");
