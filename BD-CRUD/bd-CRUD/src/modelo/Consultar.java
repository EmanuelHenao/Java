...
public class Consultar extends javax.swing.JInternalFrame {
    ...
    private String[] columNamesC = {"PALCA", "MARCA", "MODELO"};
    private DefaultTableModel modelo;
    conecBD con = new conecBD();
    private vehiculo temp;
    ...
    private void llenarTabla() {
        ...
        try {
            String sql = "SELECT placa,marca,modelo FROM Vehiculo";
            ...
            while (respuesta.next()) {
                String[] te = {
                    ...
                    respuesta.getString("marca"),
                    String.valueOf(respuesta.getInt("modelo"))
                };
    ...
    private void ConsultaSimple(String clave) {
        ...
        try {
            String sql = "SELECT placa,marca,modelo FROM Vehiculo WHERE placa = '" + clave + "'";
            PreparedStatement pstm = r.prepareStatement(sql);
            ResultSet respuesta = pstm.executeQuery();

            Clear_Table1();
            while (respuesta.next()) {
                temp.setPlaca(respuesta.getString("placa"));
                temp.setModelo(respuesta.getInt("modelo"));
                temp.setMarca(respuesta.getString("marca"));
